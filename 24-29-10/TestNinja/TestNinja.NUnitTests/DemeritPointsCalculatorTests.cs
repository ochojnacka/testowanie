...
namespace TestNinja.NUnitTests
{
    ...
    internal class DemeritPointsCalculatorTests
    {
        ...
        [TestCase(-1)]
        [TestCase(301)]
        public void CalculateDemeritPoints_SpeedIsOutRange_ThrowsArgumentOutOfRangeException(int speed)
        {
        ...
        [TestCase(70, 1)]
        [TestCase(75, 2)]
        public void CalculateDemeritPoints_WhenCalles_ReturnsDemeritPoints(int speed, int expectedPoints)
        {
            var calculator = new DemeritPointsCalculator();
